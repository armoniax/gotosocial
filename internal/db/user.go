...
type User interface {
	...
	//GetUserByUnconfirmedEmail adapt pubKey to warp unconfirmed email addresses
	GetUserByUnconfirmedEmail(ctx context.Context, unconfirmedEmail string) (*gtsmodel.User, Error)
